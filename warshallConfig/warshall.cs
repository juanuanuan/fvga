// Dafny program warshall.dfy compiled into C#
...
// Command-line arguments: run warshall.dfy --solver-path C:\Users\joaom\.vscode\extensions\dafny-lang.ide-vscode-3.5.4\out\resources\4.11.0\github\dafny\z3\bin\z3-4.12.1.exe
// warshall.dfy
...
method warshall(adj: array2<bool>) returns (R: array2<bool>)
  ...
  ensures forall u: int, v: int {:trigger existsPath(adj, u, v, adj.Length0)} {:trigger R[u, v]} | 0 <= u < adj.Length0 && 0 <= v < adj.Length1 :: R[u, v] <==> existsPath(adj, u, v, adj.Length0)
  decreases adj
{
  var n := adj.Length0;
  R := new bool[n, n];
  var i := 0;
  while i < n
    invariant 0 <= i <= n && forall o: int, p: int {:trigger existsPath(adj, o, p, 0)} {:trigger R[o, p]} | 0 <= o < i && 0 <= p < adj.Length1 :: R[o, p] <==> existsPath(adj, o, p, 0)
    decreases n - i
  {
    var j := 0;
    while j < n
      invariant 0 <= j <= n && forall t: int {:trigger existsPath(adj, i, t, 0)} {:trigger R[i, t]} | 0 <= t < j :: R[i, t] <==> existsPath(adj, i, t, 0)
      invariant 0 <= i <= n && forall o: int, p: int {:trigger existsPath(adj, o, p, 0)} {:trigger R[o, p]} | 0 <= o < i && 0 <= p < adj.Length1 :: R[o, p] <==> existsPath(adj, o, p, 0)
      decreases n - j
    {
      R[i, j] := i == j || adj[i, j];
    ...
    assert forall t: int {:trigger existsPath(adj, i, t, 0)} {:trigger R[i, t]} | 0 <= t < n :: R[i, t] <==> existsPath(adj, i, t, 0);
    i := i + 1;
  }
  var k := 0;
  while k < n
    invariant 0 <= k <= n && forall o: int, p: int {:trigger existsPath(adj, o, p, k)} {:trigger R[o, p]} | 0 <= o < n && 0 <= p < n :: R[o, p] <==> existsPath(adj, o, p, k)
    decreases n - k
  {
    var u := 0;
    while u < n
      invariant 0 <= u <= n && (forall a: int, b: int {:trigger R[a, b]} | 0 <= a < u && 0 <= b < n :: R[a, b] <==> existsPath(adj, a, b, k + 1)) && forall z: int, w: int {:trigger existsPath(adj, z, w, k)} {:trigger R[z, w]} | u <= z < n && 0 <= w < n :: R[z, w] <==> existsPath(adj, z, w, k)
      decreases n - u
    {
      var v := 0;
      while v < n
        invariant 0 <= v <= n && (forall b: int {:trigger R[u, b]} | 0 <= b < v :: R[u, b] <==> existsPath(adj, u, b, k + 1)) && forall a: int {:trigger existsPath(adj, u, a, k)} {:trigger R[u, a]} | v <= a < n :: R[u, a] <==> existsPath(adj, u, a, k)
        invariant 0 <= u <= n && (forall a: int, b: int {:trigger R[a, b]} | 0 <= a < u && 0 <= b < n :: R[a, b] <==> existsPath(adj, a, b, k + 1)) && forall z: int, w: int {:trigger existsPath(adj, z, w, k)} {:trigger R[z, w]} | u < z < n && 0 <= w < n :: R[z, w] <==> existsPath(adj, z, w, k)
        decreases n - v
      {
...
namespace _module {
  ...
  public partial class __default {
    public static bool existsPath(bool[,] adj, BigInteger u, BigInteger v, BigInteger k)
    {
      if ((k).Sign == 0) {
        return ((u) == (v)) || ((adj)[(int)(u), (int)(v)]);
      } else {
        return (__default.existsPath(adj, u, v, (k) - (BigInteger.One))) || ((__default.existsPath(adj, u, (k) - (BigInteger.One), (k) - (BigInteger.One))) && (__default.existsPath(adj, (k) - (BigInteger.One), v, (k) - (BigInteger.One))));
      }
    }
    public static bool[,] warshall(bool[,] adj)
    {
      bool[,] R = new bool[0, 0];
      BigInteger _0_n;
      _0_n = new BigInteger((adj).GetLength(0));
      bool[,] _nw0 = new bool[Dafny.Helpers.ToIntChecked(_0_n, "array size exceeds memory limit"), Dafny.Helpers.ToIntChecked(_0_n, "array size exceeds memory limit")];
      R = _nw0;
      BigInteger _1_i;
      _1_i = BigInteger.Zero;
      while ((_1_i) < (_0_n)) {
        BigInteger _2_j;
        _2_j = BigInteger.Zero;
        while ((_2_j) < (_0_n)) {
          (R)[(int)((_1_i)), (int)((_2_j))] = ((_1_i) == (_2_j)) || ((adj)[(int)(_1_i), (int)(_2_j)]);
          _2_j = (_2_j) + (BigInteger.One);
        }
        _1_i = (_1_i) + (BigInteger.One);
      }
      BigInteger _3_k;
      _3_k = BigInteger.Zero;
      while ((_3_k) < (_0_n)) {
        BigInteger _4_u;
        _4_u = BigInteger.Zero;
        while ((_4_u) < (_0_n)) {
          BigInteger _5_v;
          _5_v = BigInteger.Zero;
          while ((_5_v) < (_0_n)) {
            (R)[(int)((_4_u)), (int)((_5_v))] = ((R)[(int)(_4_u), (int)(_5_v)]) || (((R)[(int)(_3_k), (int)(_5_v)]) && ((R)[(int)(_4_u), (int)(_3_k)]));
            _5_v = (_5_v) + (BigInteger.One);
          }
          _4_u = (_4_u) + (BigInteger.One);
        }
        _3_k = (_3_k) + (BigInteger.One);
      }
      return R;
    }
    ...
    {
      bool[,] _0_adj;
      bool[,] _nw0 = new bool[Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit"), Dafny.Helpers.ToIntChecked(new BigInteger(3), "array size exceeds memory limit")];
      _0_adj = _nw0;
      (_0_adj)[(int)((BigInteger.Zero)), (int)((BigInteger.Zero))] = false;
      (_0_adj)[(int)((BigInteger.Zero)), (int)((BigInteger.One))] = true;
      (_0_adj)[(int)((BigInteger.Zero)), (int)((new BigInteger(2)))] = false;
      (_0_adj)[(int)((BigInteger.One)), (int)((BigInteger.Zero))] = false;
      (_0_adj)[(int)((BigInteger.One)), (int)((BigInteger.One))] = false;
      (_0_adj)[(int)((BigInteger.One)), (int)((new BigInteger(2)))] = true;
      (_0_adj)[(int)((new BigInteger(2))), (int)((BigInteger.Zero))] = false;
      (_0_adj)[(int)((new BigInteger(2))), (int)((BigInteger.One))] = false;
      (_0_adj)[(int)((new BigInteger(2))), (int)((new BigInteger(2)))] = false;
      bool[,] _1_R;
      bool[,] _out0;
      _out0 = __default.warshall(_0_adj);
      _1_R = _out0;
      BigInteger _2_i;
      _2_i = BigInteger.Zero;
      while ((_2_i) < (new BigInteger(3))) {
        BigInteger _3_j;
        _3_j = BigInteger.Zero;
        while ((_3_j) < (new BigInteger(3))) {
          Dafny.Helpers.Print(((_1_R)[(int)(_2_i), (int)(_3_j)]));
